...
export const PART_9_STAGES: JourneyStage[] = [
  ...
  },
  {
    ...
    title: "Root — LAM",
    subtitle: "Mantra · Root tone · 3 seconds",
    technique: "mantra",
  ...
  },
  {
    ...
    stageTypeId: "pitch-detection",
    title: "Sacral — VAM",
    subtitle: "Mantra · Sacral tone · 3 seconds",
    technique: "mantra",
  ...
  },
  {
    ...
    subtitle: "Mantra · Solar Plexus tone · 3 seconds",
    technique: "mantra",
  ...
  },
  {
    ...
    stageTypeId: "pitch-detection",
    title: "Heart — YAM",
    subtitle: "Mantra · Heart tone · 3 seconds",
    technique: "mantra",
  ...
  },
  {
    ...
    stageTypeId: "pitch-detection",
    title: "Throat — HAM",
    subtitle: "Mantra · Throat tone · 3 seconds",
    technique: "mantra",
  ...
  },
  {
    ...
    stageTypeId: "pitch-detection",
    title: "Third Eye — OM",
    subtitle: "Mantra · Third Eye tone · 3 seconds",
    technique: "mantra",
  ...
  },
  {
    ...
    stageTypeId: "pitch-detection",
    title: "Crown — AH",
    subtitle: "Mantra · Crown tone · 3 seconds",
    technique: "mantra",
