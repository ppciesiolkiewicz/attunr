  ...
  // ── Stage 3: Throat, Third Eye & Crown ──────────────────────────────────
  {
    ...
    exercises: [
      ...
      gen.scaleIntervals.pattern({
        slug: "chakra-ascent",
        title: "7-tone ascent",
        headerSubtitle: "7 tones · shifting roots",
        tempo: 80,
        scaleType: "even-7-from-major",
        startNote: 1,
        endNote: 6,
        events: [
  ...
  // ── Stage 4: Full Chakra Flow ───────────────────────────────────────────
  {
    ...
    exercises: [
      gen.scaleIntervals.pattern({
        ...
        title: "7-tone flow",
        headerSubtitle: "7 tones · shifting roots",
        cardSubtitle: "All seven tones — ascending and returning across keys",
        tempo: 80,
        scaleType: "even-7-from-major",
        startNote: 1,
        endNote: 6,
        ...
        introModal: modal.melody({
          ...
          tips: exerciseTips("melody", "advanced"),
          instruction:
            "The full chakra scale — seven tones ascending from root to crown, then descending back to root. The pattern shifts a half-step higher each repeat.\n\nFeel the energy rise through your body and then return. Notice how the descent feels different from the ascent.\n\nThis is the complete chakra flow — a single arc through all seven centres, carried across different keys.\n\nJust follow the notes. Let it be easy.",
        }),
      }),
      gen.timeBased({
        slug: "mantra-flow",
