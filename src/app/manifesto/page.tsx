    ...
    <div className="h-full overflow-y-auto manifesto-scroll">
      ...
      <div className="max-w-lg mx-auto px-6 pt-8 pb-16">
        ...
        <div className="text-center mb-2">
          ...
          >
            In Sanskrit, <em className="text-white/80" style={{ fontFamily: fraunces, fontStyle: "italic" }}>prana</em> means
            both breath and life force. In Hebrew, <em className="text-white/80" style={{ fontFamily: fraunces, fontStyle: "italic" }}>neshama</em> —
            breath and soul. In Latin, <em className="text-white/80" style={{ fontFamily: fraunces, fontStyle: "italic" }}>spiritus</em>.
            In Greek, <em className="text-white/80" style={{ fontFamily: fraunces, fontStyle: "italic" }}>pneuma</em>.
          </p>
          <p
        ...
        <p
          ...
          style={{ fontFamily: fraunces, fontWeight: 400, fontStyle: "italic", lineHeight: 1.5 }}
        >
          Your voice is just breath shaped by the body.<br />
          When you hum, you&rsquo;re giving your breath a form.<br />
        ...
        <section className="mb-2">
          ...
          <div className="manifesto-body" style={{ fontFamily: body, fontWeight: 300 }}>
            ...
            <p
              ...
              style={{ fontFamily: fraunces, fontWeight: 400, fontStyle: "italic" }}
            >
        ...
        <section className="mb-2">
          ...
          <div className="manifesto-body" style={{ fontFamily: body, fontWeight: 300 }}>
            ...
            <p className="text-[0.94rem] leading-[1.75] text-white/62">
              <strong className="text-white/78 font-normal" style={{ fontFamily: fraunces, fontWeight: 500 }}>Wellbeing</strong> — the
              immediate, felt benefit. Your nervous system calms. Your breath
              deepens. Your body releases tension. Every session leaves you feeling
              different than when you started. This is real, this is now, and for
              most people this is the reason they open the app.
            </p>
            <p className="text-[0.94rem] leading-[1.75] text-white/62">
              <strong className="text-white/78 font-normal" style={{ fontFamily: fraunces, fontWeight: 500 }}>Ancient wisdom</strong> — seed
              mantras, sustained tones, intentional vocalisation. These practices
              are thousands of years old. Attunr doesn&rsquo;t invent anything — it
              reframes what humans have always done and makes it accessible,
              structured, and progressive.
            </p>
            <p className="text-[0.94rem] leading-[1.75] text-white/62">
              <strong className="text-white/78 font-normal" style={{ fontFamily: fraunces, fontWeight: 500 }}>The authenticity crisis</strong> — the
              growing hunger for something that can&rsquo;t be faked, generated, or
              consumed passively. Your voice is the original instrument. The feeling
              it creates in your body is the original experience. No algorithm is
              between you and what you feel.
            </p>
            <p className="text-[0.94rem] leading-[1.75] text-white/62">
              <strong className="text-white/78 font-normal" style={{ fontFamily: fraunces, fontWeight: 500 }}>The post-work question</strong> — when
              people ask &ldquo;what do I do with my time, my identity, my sense of
        ...
        <div className="text-center py-6">
          <p
            ...
            style={{ fontFamily: fraunces, fontWeight: 400, fontStyle: "italic", lineHeight: 1.6 }}
          >
            Everything else can be generated.<br />
            This can only be felt.
          </p>
          <p
            className="text-base text-violet-400/60 mt-6"
            style={{ fontFamily: fraunces, fontWeight: 500, letterSpacing: "0.04em" }}
          >
