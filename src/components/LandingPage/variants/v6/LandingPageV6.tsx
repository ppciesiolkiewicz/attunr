  ...
  return (
    <div className="h-full overflow-y-auto landing-scroll v6-grain" style={{ background: "#080810", color: "#ebe8f5", fontFamily: `"Outfit", sans-serif` }}>
      <style>{`
        ...
        .v6-btn:hover {
          box-shadow: 0 0 40px rgba(124,58,237,0.5), 0 0 80px rgba(124,58,237,0.25), inset 0 1px 0 rgba(255,255,255,0.1) !important;
      ...
      <div className="relative">
        ...
        <section className="relative min-h-[100dvh] flex flex-col items-center justify-center px-6 overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center text-center max-w-2xl">
            ...
            <Link href="/journey">
              <Button
                size="lg"
                className="v6-btn px-14 text-lg cursor-pointer glow-pulse"
                style={{
                  fontFamily: fraunces,
        ...
        {/* -- How It Works (V4-style centered watermark) -- */}
