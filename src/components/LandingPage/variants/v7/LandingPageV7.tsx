...
const PARTICLE_COLORS = ["rgba(167,139,250,0.7)", "rgba(139,92,246,0.6)", "rgba(129,140,248,0.55)", "rgba(99,102,241,0.5)", "rgba(192,180,255,0.65)"];
...
export default function LandingPageV7() {
  ...
  useEffect(() => {
    ...
    function onMouseMove(e: MouseEvent) {
      for (const dot of alive) {
        ...
        if (dist < CAPTURE_RADIUS) {
          captured.add(dot);
          capturedCount++;
          dot.style.transition = "transform 0.25s cubic-bezier(0.22, 1, 0.36, 1), opacity 0.25s ease";
          ...
          dot.style.transition = "transform 0.6s cubic-bezier(0.22, 1, 0.36, 1)";
          dot.style.transform = `translate(${tx}px, ${ty}px)`;
        } else {
          dot.style.transition = "transform 0.8s cubic-bezier(0.22, 1, 0.36, 1)";
      ...
      if (glow) {
        ...
        const glowOpacity = capturedCount === 0 ? 0 : Math.min(0.15 + capturedCount * 0.08, 0.85);
    ...
    function onMouseLeave() {
      for (const dot of captured) {
        dot.style.transition = "transform 1.5s cubic-bezier(0.22, 1, 0.36, 1), opacity 1.5s ease";
        dot.style.transform = "translate(0, 0)";
        dot.style.opacity = String(dot.style.getPropertyValue("--p-opacity") || "0.5");
        dot.style.animation = "";
      }
      captured.clear();
      capturedCount = 0;
  ...
  return (
    <div className="h-full overflow-y-auto landing-scroll v7-grain" style={{ background: "#080810", color: "#ebe8f5", fontFamily: `"Outfit", sans-serif`, cursor: "default" }}>
      <style>{`
      ...
      <div className="v7-mesh">
        <div className="v7-mesh-blob" style={{ width: 600, height: 600, top: "5%", left: "-10%", background: "radial-gradient(circle, rgba(139,92,246,0.08), transparent 70%)", animation: "v7-mesh-drift-1 20s ease-in-out infinite" }} />
        <div className="v7-mesh-blob" style={{ width: 500, height: 500, top: "40%", right: "-5%", background: "radial-gradient(circle, rgba(99,102,241,0.06), transparent 70%)", animation: "v7-mesh-drift-2 25s ease-in-out infinite" }} />
        <div className="v7-mesh-blob" style={{ width: 450, height: 450, bottom: "10%", left: "20%", background: "radial-gradient(circle, rgba(59,130,246,0.05), transparent 70%)", animation: "v7-mesh-drift-3 18s ease-in-out infinite" }} />
      </div>
      ...
      <div ref={particlesRef} className="fixed inset-0 pointer-events-none z-10">
        <div
          ...
          style={{
            background: "radial-gradient(circle, rgba(167,139,250,0.8) 0%, rgba(139,92,246,0.4) 40%, transparent 70%)",
            filter: "blur(8px)",
            opacity: 0,
      ...
      <div className="relative">
        ...
        <section className="relative min-h-dvh flex flex-col items-center justify-center px-6 overflow-hidden">
          ...
          <div
            ...
            style={{
              width: 1000,
              height: 700,
              background: "radial-gradient(ellipse, rgba(168,85,247,0.55) 0%, rgba(139,92,246,0.3) 25%, rgba(99,102,241,0.15) 45%, transparent 65%)",
              filter: "blur(60px)",
        ...
        <section className="landing-section relative px-6 py-16 sm:py-20">
          <div
            ...
            style={{ width: 900, height: 450, background: "radial-gradient(ellipse, rgba(99,102,241,0.12) 0%, rgba(99,102,241,0.04) 40%, transparent 70%)", filter: "blur(60px)" }}
          />
          <div className="relative max-w-4xl mx-auto">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl text-white text-center mb-14" style={{ fontFamily: fraunces, fontWeight: 700 }}>
              The <span className="v7-chromatic" data-text="reset">reset</span> your body already knows
            </h2>
        ...
        <section className="landing-section relative px-6 py-16 sm:py-20">
          <div
            className="absolute -top-8 left-1/2 -translate-x-1/2 z-0 pointer-events-none"
            style={{ width: 900, height: 450, background: "radial-gradient(ellipse, rgba(34,197,94,0.12) 0%, rgba(34,197,94,0.04) 40%, transparent 70%)", filter: "blur(60px)" }}
          />
          <div className="relative max-w-2xl mx-auto text-center">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl text-white mb-4 leading-tight" style={{ fontFamily: fraunces, fontWeight: 700 }}>
              Not <span className="v7-chromatic" data-text="singing">singing</span> lessons.
            </h2>
            <p className="text-xl sm:text-2xl text-white/40 mb-8" style={{ fontFamily: body }}>
              A body practice that uses <span className="v7-chromatic" data-text="sound">sound</span>.
            </p>
        ...
        <section className="landing-section relative px-6 py-20 sm:py-28">
          <div
            className="absolute -top-8 left-1/2 -translate-x-1/2 z-0 pointer-events-none"
            style={{ width: 900, height: 450, background: "radial-gradient(ellipse, rgba(234,179,8,0.08) 0%, rgba(234,179,8,0.02) 40%, transparent 70%)", filter: "blur(60px)" }}
          />
          <div className="relative max-w-2xl mx-auto">
            <p className="text-xs uppercase tracking-[0.25em] text-violet-400/60 text-center mb-3" style={{ fontFamily: fraunces }}>
              Start in two minutes
            </p>
            <h2 className="text-3xl sm:text-4xl md:text-5xl text-white text-center mb-20" style={{ fontFamily: fraunces, fontWeight: 700 }}>
              As easy as taking a <span className="v7-chromatic" data-text="deep breath">deep breath</span>
            </h2>
              ...
              {STEPS.map((step, i) => (
                <div key={step.title} className="relative text-center">
                  ...
                  <span
                    ...
                    style={{ fontFamily: fraunces, fontWeight: 900, color: "rgba(139,92,246,0.25)" }}
                  >
                    {String(i + 1).padStart(2, "0")}
                  </span>
                  <div className="relative z-10">
                    <h3 className="text-xl sm:text-2xl text-white mb-3" style={{ fontFamily: fraunces, fontWeight: 600 }}>
                      {step.title}
                    </h3>
                    <p className="text-white/55 leading-relaxed max-w-sm mx-auto" style={{ fontFamily: body }}>
                      {step.body}
                    </p>
                  </div>
                </div>
        ...
        <section className="landing-section relative px-6 py-16 sm:py-20">
          <div
            className="absolute -top-8 left-1/2 -translate-x-1/2 z-0 pointer-events-none"
            style={{ width: 900, height: 450, background: "radial-gradient(ellipse, rgba(239,68,68,0.08) 0%, rgba(239,68,68,0.02) 40%, transparent 70%)", filter: "blur(60px)" }}
          />
          <div className="relative max-w-xl mx-auto text-center">
            <p className="text-2xl sm:text-3xl md:text-4xl text-white leading-snug mb-3" style={{ fontFamily: fraunces, fontWeight: 600 }}>
              Your voice is already the <span className="v7-chromatic" data-text="instrument">instrument</span>.
            </p>
